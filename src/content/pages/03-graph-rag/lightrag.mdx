...
3. **Keyword-based retrieval** -- instead of embedding-based search over summaries, LightRAG extracts keywords from queries and matches them against entities and relationships in the graph.
