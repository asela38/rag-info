...
| <CrossReference slug="03-graph-rag/hipporag" /> | Hippocampal memory model + <CrossReference slug="03-graph-rag/ppr" inline /> | Pattern separation + completion for context recovery, uses PPR to walk the graph for contextually connected nodes |
