...
relatedPages: ["05-synthesis/progressive-map", "05-synthesis/indexing-comparison", "01-foundation/problem-tree"]
prev: "05-synthesis/indexing-comparison"
next: ""
...
**This guide helps you choose the right RAG approach based on your specific requirements, not what's trendy.**

**Start here:**
1. What are your query patterns? (single-hop vs. multi-hop)
2. What's your latency budget? (real-time vs. batch)
3. What's your indexing budget? (cheap vs. expensive preprocessing)
4. What are your failure modes? (symmetry, context loss, keyword blindness)

**Decision framework:** Use the decision tree and comparison tables to match your constraints to the right technique.

**Remember:** Start simple (Naive + Hybrid), measure failures, add complexity only where needed.
...
Each layer from the <CrossReference slug="05-synthesis/progressive-map" /> can be added incrementally:
