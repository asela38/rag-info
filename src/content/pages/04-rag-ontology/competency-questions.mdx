...
order: 2
prerequisites: ["04-rag-ontology/ontology"]
relatedPages: ["03-graph-rag/graphrag", "04-rag-ontology/rag-ontology-map"]
prev: "04-rag-ontology/ontology"
next: "04-rag-ontology/rag-ontology-map"
...
**Competency Questions (CQs) are the systematic way to design ontologies: start with scenarios → derive questions the ontology must answer → build axioms that answer them.**

**The Gruninger & Fox methodology:** Turns ontology design from guesswork into engineering. No boxes and arrows until you know what questions you're answering.

**Five CQ types for RAG:**
1. **Existence:** What entities/processes exist?
2. **Classification:** What types do they belong to?
3. **Relationship:** How are they connected?
4. **Property:** What qualities do they have?
5. **Temporal:** When/how do things change?

**Why use CQs:** Validates that your ontology actually supports the reasoning you need. If a CQ can't be answered, the ontology is incomplete.

</SummaryBox>

## Why Not Just Draw Boxes and Arrows?

The <CrossReference slug="04-rag-ontology/ontology" /> page introduced endurants and perdurants — but how do ontologists actually *decide* what goes into an ontology? They don't just brainstorm entities. They use **Competency Questions** (CQs): precise questions that define what the ontology must be able to answer.
...
Answer: **Role** — the same software component might play the Retriever role in one pipeline and the Indexer role in another. See the <CrossReference slug="04-rag-ontology/ontology" /> discussion of endurants vs perdurants.

The <CrossReference slug="04-rag-ontology/foundational-ontologies" /> page compares how different foundational ontologies handle these categorizations.
...
Now that we understand the methodology, let's apply it. The <CrossReference slug="04-rag-ontology/rag-ontology-map" /> shows the complete RAG ontology derived from these competency questions.
