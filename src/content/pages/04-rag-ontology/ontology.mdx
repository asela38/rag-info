...
```mermaid
graph LR
    A["Acme Corp\n(Organization)"] -->|"acquired"| B["Beta Inc\n(Organization)"]
    A -->|"valued_at"| C["$2B"]
...
```mermaid
graph TD
    A["Acme Corp\n(Organization)"] -->|"acquirer"| E["Acquisition of Beta\n(Event / Perdurant)"]
    B["Beta Inc\n(Organization)"] -->|"acquired_entity"| E
    E -->|"date"| D["2023"]
    E -->|"value"| V["$2B"]
    E -->|"status"| S["Pending Regulatory\nApproval"]
    E -->|"phase_of"| P["Regulatory Review\n(Sub-Event)"]
